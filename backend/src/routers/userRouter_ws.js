...
router_ws.get("/users_ws",getUser_ws);
router_ws.get("/users_ws/:id_ws", getUserId_ws);
router_ws.post("/users_ws",createUser_ws);
router_ws.put("/users_ws/:id_ws", updateUserId_ws);
router_ws.delete("/users_ws/:id_ws", deleteUserId_ws);
